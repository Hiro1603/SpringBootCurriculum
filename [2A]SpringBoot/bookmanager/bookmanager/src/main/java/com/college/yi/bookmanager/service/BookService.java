...
public class BookService {
	...
	public List<Book> getFixedBookData(){
		...
		List<Book> fixedBookData = new ArrayList<Book>();
		fixedBookData.add(book1);
		fixedBookData.add(book2);
		fixedBookData.add(book3);
		fixedBookData.add(book4);
		fixedBookData.add(book5);
		
		return fixedBookData;
	}
